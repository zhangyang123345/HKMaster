  ...
  <div class="d-chart-item dashboard8" @mouseleave="runCon">
    <div class='detail-list'>
      ...
      <div  class="tableItem" v-show="current==2">
        ...
        <div id="tecGround" style="height: 200px;width: 100%">
        </div>
      ...
      <div  class="tableItem" v-show="current==4">
        <div class='detail-list-item' key='4'>
  ...
  export default {
    ...
    methods: {
      ...
      drawLine () {
        ...
        this.myChart4 = this.$echarts.init(document.getElementById('human4'))
