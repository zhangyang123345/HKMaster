<template>
  <div class="d-chart-item DashboardR16">
    ...
    <el-col :gutter="24" class="el-row" style='height:100%;width: 100%' type="flex">
      <el-row :span="1" style='height:10%;width: 100%'>
        <p class="ptitle">人均单片(D5X)</p>
      </el-row>
      <el-row :span="23" style='height:90%;width: 100%'>
        <div id='echarts_top1' style='margin:0 auto;height:100%;width: 100%' ></div>
      </el-row>
    </el-col>
    <!--</div>-->
  </div>
...
<script>
  export default {
    ...
    methods: {
      drawLine () {
        let _that = this
        this.myChart = this.$echarts.init(document.getElementById('echarts_top1'))
        this.option = {
          title: {
            text: '{a|' + this.value + '}{c|%}',
            x: 'center',
